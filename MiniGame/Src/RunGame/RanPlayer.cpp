...
/*　　　　　更新関数        　*/
/*============================*/
void RunGame::RanPlayer::Update()
{
	switch (m_CurrentStep)
	{
	case RanPlayer::PlayerStep::STEP_INIT:
		// 初期化ステップ
		Init();
		m_CurrentStep = PlayerStep::STEP_UPDATE;
		
		break;
	case RanPlayer::PlayerStep::STEP_UPDATE:
	{
...
/*　　　　ジャンプ関数     　*/
/*===========================*/
void RunGame::RanPlayer::Jump()
{
	if (m_OnGround && Input::GetKey() == 'r')
	{
...
/*　　　ブロックと当たっているかを調べる関数     */
/*===============================================*/
void RunGame::RanPlayer::ChecHitBlock()
{
